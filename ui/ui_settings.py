...
#
# Created: Wed Jun 12 16:00:49 2013
...
class Ui_Settings(object):
    def setupUi(self, Settings):
        ...
        self.obsDistanceSnapping = QtGui.QComboBox(self.groupBox)
        self.obsDistanceSnapping.setObjectName(_fromUtf8("obsDistanceSnapping"))
        self.obsDistanceSnapping.addItem(_fromUtf8(""))
        self.obsDistanceSnapping.addItem(_fromUtf8(""))
        self.obsDistanceSnapping.addItem(_fromUtf8(""))
        self.gridLayout_7.addWidget(self.obsDistanceSnapping, 0, 1, 1, 2)
        ...
        self.gridLayout_7.addWidget(self.obsDefaultPrecisionDistance, 1, 2, 1, 1)
        ...
        self.obsDirectionLength = QtGui.QDoubleSpinBox(self.groupBox_3)
        self.obsDirectionLength.setDecimals(1)
        self.obsDirectionLength.setProperty("value", 8.0)
        self.obsDirectionLength.setObjectName(_fromUtf8("obsDirectionLength"))
        self.gridLayout_8.addWidget(self.obsDirectionLength, 1, 1, 1, 1)
        self.label_8 = QtGui.QLabel(self.groupBox_3)
        self.label_8.setObjectName(_fromUtf8("label_8"))
        self.gridLayout_8.addWidget(self.label_8, 1, 0, 1, 1)
        self.obsDirectionDefaultPrecision = QtGui.QDoubleSpinBox(self.groupBox_3)
        self.obsDirectionDefaultPrecision.setEnabled(True)
        self.obsDirectionDefaultPrecision.setMaximum(2.0)
        self.obsDirectionDefaultPrecision.setSingleStep(0.1)
        self.obsDirectionDefaultPrecision.setProperty("value", 0.5)
        self.obsDirectionDefaultPrecision.setObjectName(_fromUtf8("obsDirectionDefaultPrecision"))
        self.gridLayout_8.addWidget(self.obsDirectionDefaultPrecision, 0, 1, 1, 1)
        ...
        self.observationField = QtGui.QComboBox(self.dimensionTab)
        self.observationField.setObjectName(_fromUtf8("observationField"))
        self.formLayout.setWidget(1, QtGui.QFormLayout.FieldRole, self.observationField)
    ...
    def retranslateUi(self, Settings):
        ...
        self.label_9.setText(QtGui.QApplication.translate("Settings", "Snapping", None, QtGui.QApplication.UnicodeUTF8))
        self.obsDistanceSnapping.setItemText(0, QtGui.QApplication.translate("Settings", "no", None, QtGui.QApplication.UnicodeUTF8))
        self.obsDistanceSnapping.setItemText(1, QtGui.QApplication.translate("Settings", "according to project settings", None, QtGui.QApplication.UnicodeUTF8))
        self.obsDistanceSnapping.setItemText(2, QtGui.QApplication.translate("Settings", "on vertex of all layers", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.groupBox_3.setTitle(QtGui.QApplication.translate("Settings", "Directions", None, QtGui.QApplication.UnicodeUTF8))
        self.label_4.setText(QtGui.QApplication.translate("Settings", "Default precision for directions [°]", None, QtGui.QApplication.UnicodeUTF8))
