...
class Ui_Settings(object):
    def setupUi(self, Settings):
        ...
        self.threshBox = QtGui.QDoubleSpinBox(self.groupBox_2)
        self.threshBox.setDecimals(4)
        self.threshBox.setMaximum(1.0)
        self.threshBox.setSingleStep(0.01)
        self.threshBox.setProperty("value", 0.0005)
        self.threshBox.setObjectName(_fromUtf8("threshBox"))
        self.gridLayout_5.addWidget(self.threshBox, 0, 1, 1, 1)
        self.maxIterBox = QtGui.QSpinBox(self.groupBox_2)
        self.maxIterBox.setProperty("value", 15)
        self.maxIterBox.setObjectName(_fromUtf8("maxIterBox"))
        self.gridLayout_5.addWidget(self.maxIterBox, 1, 1, 1, 1)
